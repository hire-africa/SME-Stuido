    ...
    <main className="min-h-screen bg-white">
      ...
      <nav className="border-b border-gray-200 sticky top-0 z-50 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-4 items-center">
            <Link href="/pricing" className="px-4 py-2 text-navy hover:text-emerald transition">
              Pricing
            </Link>
            <Link href="/login" className="px-4 py-2 text-navy hover:text-emerald transition">
              Login
            </Link>
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-emerald hover:shadow-lg transition">
            <FileText className="text-emerald mb-4" size={40} />
            <h3 className="text-xl font-bold text-navy mb-3">Business Proposals</h3>
          ...
          <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-emerald hover:shadow-lg transition">
            ...
            <h3 className="text-xl font-bold text-navy mb-3">Pitch Decks</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-emerald hover:shadow-lg transition">
            ...
            <h3 className="text-xl font-bold text-navy mb-3">Loan Applications</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-emerald hover:shadow-lg transition">
            ...
            <h3 className="text-xl font-bold text-navy mb-3">Company Profiles</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-emerald hover:shadow-lg transition">
            <TrendingUp className="text-emerald mb-4" size={40} />
            <h3 className="text-xl font-bold text-navy mb-3">Cashflow Engine</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-emerald hover:shadow-lg transition">
            ...
            <h3 className="text-xl font-bold text-navy mb-3">AI Business Coach</h3>
            <p className="text-gray-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {['Agriculture', 'Restaurants', 'Transport', 'Retail', 'Fashion', 'ICT', 'Tourism', 'Manufacturing', 'Creative', 'Music & Events', 'Beauty & Salons', 'Trading'].map((sector) => (
              <div key={sector} className="bg-white border border-gray-200 rounded-lg p-4 text-center hover:border-emerald transition">
                <p className="text-navy font-semibold">{sector}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
          ...
          <div className="bg-white border-2 border-gray-200 rounded-xl p-8">
            <h3 className="text-2xl font-bold text-navy mb-4">Monthly Plan</h3>
            <div className="mb-6">
